...
typedef struct IEcoLab1VTbl {
    ...
    /* IEcoLab1 */
    int16_t (ECOCALLMETHOD *combSortInt)(/* in */ IEcoLab1Ptr_t me, /* in */ int* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *combSortLong)(/* in */ IEcoLab1Ptr_t me, /* in */ long* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *combSortFloat)(/* in */ IEcoLab1Ptr_t me, /* in */ float* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *combSortDouble)(/* in */ IEcoLab1Ptr_t me, /* in */ double* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *combSortLongDouble)(/* in */ IEcoLab1Ptr_t me, /* in */ long double* array, /* in */ int size);
